...
define('posts/list',['exports', 'aurelia-framework', 'aurelia-event-aggregator', 'aurelia-router', '../api/posts', '../api/blog'], function (exports, _aureliaFramework, _aureliaEventAggregator, _aureliaRouter, _posts, _blog) {
  'use strict';
  ...
  var List = exports.List = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _blog.Blog, _posts.Posts, _aureliaEventAggregator.EventAggregator), _dec(_class = function () {
    function List(router, blog, posts, ea) {
    ...
    List.prototype.dettach = function dettach() {
    ...
    List.prototype.navigate = function navigate(_ref3) {
      ...
      return new Promise(function (resolve) {
        _this.order = _this.current < navigateTo ? 'asc' : 'desc';
        _this._resetPaginateListener();
        _this._paginateListener = _this.ea.subscribe('router:navigation:success', function () {
          _this._paginateListener.dispose();
          resolve();
          var top = window.scrollY + _this.content.getBoundingClientRect().top;
          window.scroll({ top: top, behavior: 'smooth' });
        });
        if (navigateTo > 1) {
          _this.router.navigateToRoute('posts', { page: navigateTo });
        } else {
    ...
    List.prototype._resetPaginateListener = function _resetPaginateListener() {
...
define('posts/post',['exports', 'aurelia-framework', '../api/posts', '../api/labs'], function (exports, _aureliaFramework, _posts, _labs) {
  ...
  var Post = exports.Post = (_dec = (0, _aureliaFramework.inject)(Element, _posts.Posts, _labs.Labs), _dec(_class = function () {
    function Post(element, postsService, labs) {
...
define('posts/posts',["exports"], function (exports) {
  "use strict";
...
define('resources/elements/main-header',['exports', 'aurelia-framework', 'aurelia-event-aggregator', '../../api/posts', '../../api/blog', './main-nav-service'], function (exports, _aureliaFramework, _aureliaEventAggregator, _posts, _blog, _mainNavService) {
  'use strict';
  ...
  var MainHeaderCustomElement = exports.MainHeaderCustomElement = (_dec = (0, _aureliaFramework.inject)(_aureliaEventAggregator.EventAggregator, _blog.Blog, _posts.Posts, _mainNavService.MainNavService), _dec2 = (0, _aureliaFramework.computedFrom)('post', 'blog'), _dec(_class = (_class2 = function () {
    ...
    function MainHeaderCustomElement(ea, blog, postsService, mainNavService) {
      var _this = this;
    ...
    MainHeaderCustomElement.prototype.toggle = function toggle() {
...
define('resources/elements/main-loader',['exports', 'aurelia-framework', 'aurelia-event-aggregator'], function (exports, _aureliaFramework, _aureliaEventAggregator) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.MainLoaderCustomElement = undefined;
  ...
  var MainLoaderCustomElement = exports.MainLoaderCustomElement = (_dec = (0, _aureliaFramework.inject)(Element, _aureliaEventAggregator.EventAggregator), _dec(_class = (_class2 = function () {
    function MainLoaderCustomElement(element, ea) {
      _classCallCheck(this, MainLoaderCustomElement);
    ...
    MainLoaderCustomElement.prototype.currentChanged = function currentChanged(newVal) {
      this.progress.style.width = newVal + '%';
    };

    MainLoaderCustomElement.prototype.attached = function attached() {
      var _this = this;

      this._processing = this.ea.subscribe('router:navigation:processing', function () {
        return _this._start();
      });
      this._canceling = this.ea.subscribe('router:navigation:canceled', function () {
        return _this._cancel();
      });
      this._successing = this.ea.subscribe('router:navigation:success', function () {
        return _this._success();
      });
    };

    MainLoaderCustomElement.prototype.detached = function detached() {
      this._processing.dispose();
      this._canceling.dispose();
      this._successing.dispose();
    };

    MainLoaderCustomElement.prototype._start = function _start() {
      var _this2 = this;
      ...
      this._poll = setInterval(function () {
        return _this2._increment();
      }, 1);
    };

    MainLoaderCustomElement.prototype._increment = function _increment(v) {
      this.current = Math.min((this.current || 1) * 1.01, 100);
    };

    MainLoaderCustomElement.prototype._cancel = function _cancel() {
      var _this3 = this;
    ...
    MainLoaderCustomElement.prototype._success = function _success() {
      var _this4 = this;
    ...
    MainLoaderCustomElement.prototype._show = function _show() {
      this.element.classList.add('visible');
    };

    MainLoaderCustomElement.prototype._hide = function _hide() {
      this.element.classList.remove('visible');
    };

    return MainLoaderCustomElement;
...
define('resources/elements/main-nav-service',['exports', 'aurelia-framework'], function (exports, _aureliaFramework) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.MainNavService = undefined;
  ...
  var NAV_CLOSED = 'nav-closed';
  var NAV_OPENED = 'nav-opened';

  var MainNavService = exports.MainNavService = (_dec = (0, _aureliaFramework.inject)(document.body.classList), _dec(_class = function () {
    function MainNavService(bodyClassList) {
      _classCallCheck(this, MainNavService);

      this.bodyClassList = bodyClassList;
    }

    MainNavService.prototype.toggle = function toggle() {
    ...
    MainNavService.prototype.close = function close() {
      this.bodyClassList.remove(NAV_OPENED);
      this.bodyClassList.add(NAV_CLOSED);
    };

    MainNavService.prototype.open = function open() {
...
define('resources/elements/main-nav',['exports', 'aurelia-framework', './main-nav-service'], function (exports, _aureliaFramework, _mainNavService) {
  'use strict';
  ...
  var MainNav = exports.MainNav = (_dec = (0, _aureliaFramework.inject)(_mainNavService.MainNavService), _dec(_class = function () {
    function MainNav(mainNavService) {
      _classCallCheck(this, MainNav);

      this.mainNavService = mainNavService;
    }

    MainNav.prototype.close = function close() {
...
define('text!animations.css', ['module'], function(module) { module.exports = ".au-animate {\n  -webkit-animation-delay: 1000ms;\n  animation-delay: 1000ms; }\n\n.au-enter {\n  opacity: 0 !important; }\n\n.au-enter-active {\n  -webkit-animation: fadeIn 1s;\n  animation: fadeIn 1s; }\n\n.au-leave-active {\n  -webkit-animation: fadeOut 1s;\n  animation: fadeOut 1s; }\n\npost-in-list {\n  display: block;\n  -webkit-animation-delay: 1000ms;\n  animation-delay: 1000ms; }\n  post-in-list.au-enter-active {\n    -webkit-animation: swipeDownAndFadeIn 1s;\n    animation: swipeDownAndFadeIn 1s; }\n  post-in-list.au-leave-active {\n    -webkit-animation: swipeUpAndFadeOut 1s;\n    animation: swipeUpAndFadeOut 1s; }\n\n.desc post-in-list.au-enter-active {\n  -webkit-animation: swipeUpAndFadeIn 1s;\n  animation: swipeUpAndFadeIn 1s; }\n\n.desc post-in-list.au-leave-active {\n  -webkit-animation: swipeDownAndFadeOut 1s;\n  animation: swipeDownAndFadeOut 1s; }\n\n/* CSS3-Animations */\n@-webkit-keyframes fadeIn {\n  0% {\n    opacity: 0; }\n  100% {\n    opacity: 1; } }\n\n@keyframes fadeIn {\n  0% {\n    opacity: 0; }\n  100% {\n    opacity: 1; } }\n\n@-webkit-keyframes fadeOut {\n  0% {\n    opacity: 1; }\n  100% {\n    opacity: 0; } }\n\n@keyframes fadeOut {\n  0% {\n    opacity: 1; }\n  100% {\n    opacity: 0; } }\n\n@-webkit-keyframes swipeUpAndFadeOut {\n  0% {\n    opacity: 1;\n    -webkit-transform: translate3d(0, 0, 0); }\n  100% {\n    opacity: 0;\n    -webkit-transform: translate3d(0, -100%, 0); } }\n\n@keyframes swipeUpAndFadeOut {\n  0% {\n    opacity: 1;\n    transform: translate3d(0, 0, 0); }\n  100% {\n    opacity: 0;\n    transform: translate3d(0, -100%, 0); } }\n\n@-webkit-keyframes swipeDownAndFadeIn {\n  0% {\n    opacity: 0;\n    -webkit-transform: translate3d(0, 100%, 0); }\n  100% {\n    opacity: 1;\n    -webkit-transform: translate3d(0, 0, 0); } }\n\n@keyframes swipeDownAndFadeIn {\n  0% {\n    opacity: 0;\n    transform: translate3d(0, 100%, 0); }\n  100% {\n    opacity: 1;\n    transform: translate3d(0, 0, 0); } }\n\n@-webkit-keyframes swipeDownAndFadeOut {\n  0% {\n    opacity: 1;\n    -webkit-transform: translate3d(0, 0, 0); }\n  100% {\n    opacity: 0;\n    -webkit-transform: translate3d(0, 100%, 0); } }\n\n@keyframes swipeDownAndFadeOut {\n  0% {\n    opacity: 1;\n    transform: translate3d(0, 0, 0); }\n  100% {\n    opacity: 0;\n    transform: translate3d(0, 100%, 0); } }\n\n@-webkit-keyframes swipeUpAndFadeIn {\n  0% {\n    opacity: 0;\n    -webkit-transform: translate3d(0, -100%, 0); }\n  100% {\n    opacity: 1;\n    -webkit-transform: translate3d(0, 0, 0); } }\n\n@keyframes swipeUpAndFadeIn {\n  0% {\n    opacity: 0;\n    transform: translate3d(0, -100%, 0); }\n  100% {\n    opacity: 1;\n    transform: translate3d(0, 0, 0); } }\n"; });
...
define('text!resources/elements/main-nav.html', ['module'], function(module) { module.exports = "<template>\n<div\n  class=\"nav\">\n  <h3\n    class=\"nav-title\">Menu</h3>\n  <a\n    href=\"#\"\n    class=\"nav-close\"\n    click.delegate=\"close()\">\n    <span class=\"hidden\">Close</span>\n  </a>\n  <ul>\n    <li\n      class=\"nav-home nav-current\"\n      role=\"presentation\"><a href=\"/\">Home</a></li>\n    <li\n      class=\"nav-coin nav-current\" role=\"presentation\"><a href=\"/\">Coin</a></li>\n  </ul>\n  <a class=\"subscribe-button icon-feed\" href=\"/rss/\">Subscribe</a>\n</div>\n</template>\n"; });
